...
public class DraggableTab extends Tab {
	...
	/**
	 * @return the isEnteringAction
	 */
	public boolean isEnteringAction() {
		return isEnteringAction;
	}

	public void flipisEnteringAction() {
		isEnteringAction = !isEnteringAction;
	}

	/**
	 * @param isEnteringAction the isEnteringAction to set
	 */
	public void setEnteringAction(boolean isEnteringAction) {
		this.isEnteringAction = isEnteringAction;
	}
